...
class DataTransformation:
        ...
        try:
            ...
            preprocessor= ColumnTransformer(
                ...
                [
                    ...
                    ("cat_pipeline", categorical_pipleline, categorical_columns)
    ...
    def initiate_data_transformation(self, train_path,test_path):
        try:
            ...
            save_object(
                file_path= self.datat_transformation_config.preprocessor_obj_file_path,
                obj= preprocessing_obj
            )

            return (train_arr,
                    test_arr,
                    self.datat_transformation_config.preprocessor_obj_file_path)
        except Exception as e:
            raise CustomException(e,sys)
